import { Dictionary, DictionaryEntry } from "../../interface/searchInterface";

class StyleDictonary implements Dictionary{
    private entries: DictionaryEntry[];
    private termToCanonical: Map<string, string>;
    private allTerms: string[];
    
    constructor(styles: DictionaryEntry[]) {
      this.entries = styles;
